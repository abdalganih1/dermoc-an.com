...
const translations = {
    en: {
        ...
        gentleDesc: "For sensitive skin. 2g peeling powder, 2-4 minutes massage.",
        moderateProtocol: "Moderate",
        moderateDesc: "For normal skin. 2g peeling powder, 4-6 minutes massage.",
        intensiveProtocol: "Intensive",
        intensiveDesc: "For resistant skin. 2g peeling powder, 6-8 minutes massage.",
        ...
        step1Tip: "Pro Tip: Use a facial steamer to open pores before treatment.",
        step2Title: "Prepare the Mixture",
        step2Desc: "Mix 2g of Algae Peeling Powder with the Support Solution until you achieve a smooth, even consistency.",
        ...
        step5Title: "Wipe Clean",
        step5Desc: "Gently wipe the treatment area with damp cloths to completely remove all powder residue.",
        step5Tip: "Pro Tip: Use soft, damp cloths and wipe gently to remove all traces.",
        step6Title: "Apply Calming Mask",
        step6Desc: "Apply a generous layer of Calming Mask and leave for 10-15 minutes. Leave exposed to air to cool naturally.",
        step6Tip: "Pro Tip: Do not cover - let the mask cool naturally on the skin.",
        step7Title: "Sun Protection",
        step7Desc: "Finish with SPF 50+ sunscreen. Apply every 3 hours for the next 5 days. This is MANDATORY.",
        ...
        sunExposureDesc: "Stay out of direct sunlight for 5 days after treatment.",
        ...
        treatmentIntervalDesc: "Wait at least 1 month between sessions. Sessions less than 1 month apart are not allowed.",
        ...
        // Gentle Steps
        gentle_step1: "2-4 minutes massage",
        ...
        // Moderate Steps
        moderate_step1: "4-6 minutes massage",
        ...
        // Intensive Steps
        intensive_step1: "6-8 minutes massage",
        ...
        faq_a2: "You may feel warmth or tingling only during the powder application (maximum 10 minutes). After removal, the sensation disappears completely with no pain.",
        faq_q3: "When will I start seeing results?",
        faq_a3: "You'll see excellent results immediately after the session. Initial results appear after 5 days, with final results at 25 days. Based on skin condition, most clients need no more than 4 sessions total.",
        faq_q4: "Can I use the products at home?",
        faq_a4: "For home care after treatment, we only recommend applying SPF 50+ sunscreen every 3 hours for 5 days. No other products are needed.",
        ...
        faq_a8: "Never pick or pull peeling skin by hand. Using sunscreen helps the skin peel and fall off naturally, preventing any damage to the skin.",
        ...
        daysCare3Desc: "Apply SPF 50+ sunscreen every 3 hours. Wear a hat and avoid direct sunlight for 5 days.",
        ...
        // Support Solution Page
        support_step1Title: "Measure",
        support_step1Desc: "Pour the appropriate amount of Support Solution into a mixing bowl.",
        support_step2Title: "Mix",
        support_step2Desc: "Gradually add Algae Peeling Powder while stirring until a smooth paste forms.",
        support_step3Title: "Consistency",
        support_step3Desc: "Adjust the ratio for desired consistency - thicker for body, thinner for face.",
        support_step4Title: "Apply",
        support_step4Desc: "Use immediately after mixing for optimal activation and results.",
        roleInTreatment: "Role in Treatment",
        activatesPowder: "Activates Powder",
        antisepticAction: "Antiseptic Action",
        maintainsMoisture: "Maintains Moisture",
        brighteningEffect: "Brightening Effect",
        activeIngredients: "Active Ingredients",
        supportFormula: "Support Formula",
        supportFormulaDesc: "Carefully selected bioactive compounds that activate and enhance the peeling treatment",
        daisyBrief: "Brightens & evens tone",
        ingGlycerinTitle: "Glycerin",
        glycerinBrief: "Deep hydration & softening",
        ingH2O2: "Hydrogen Peroxide",
        h2o2Brief: "Purification & activation",

        // Calming Mask Page
        mask_step1Title: "Cleanse",
        mask_step1Desc: "After peeling treatment, gently remove all residue with warm water.",
        mask_step2Title: "Apply",
        mask_step2Desc: "Apply a generous layer of Calming Mask evenly across the treated area.",
        mask_step3Title: "Wait",
        mask_step3Desc: "Leave the mask on for 15-20 minutes to allow deep absorption.",
        mask_step4Title: "Remove",
        mask_step4Desc: "Gently remove with a damp cloth or rinse with cool water. Follow with SPF.",
        skinBenefits: "Skin Benefits",
        reducesRedness: "Reduces Redness",
        restoresMoisture: "Restores Moisture",
        calmsSkin: "Calms Irritation",
        protectsBarrier: "Protects Barrier",
        promoteHealing: "Promotes Healing",
        soothingActives: "Soothing Actives",
        calmingFormula: "Calming Formula",
        calmingFormulaDesc: "Botanical extracts and hydrating compounds designed to restore skin after intensive treatments",
        aloeBrief: "Healing & anti-inflammatory",
        cucumberBrief: "Cooling & refreshing",
        hyaluronateBrief: "Deep moisture retention",
        chamomileBrief: "Anti-redness & calming",

        // Sunscreen Page
        sun_step1Title: "Prepare",
        sun_step1Desc: "Apply on clean, dry skin as the final step in your skincare routine.",
        sun_step2Title: "Apply",
        sun_step2Desc: "Use a generous amount and spread evenly on face, neck, and exposed areas.",
        sun_step3Title: "Wait",
        sun_step3Desc: "Allow 15 minutes before sun exposure for optimal protection.",
        sun_step4Title: "Reapply",
        sun_step4Desc: "Reapply every 2 hours, or after swimming or excessive sweating.",
        protectiveActives: "Protective Actives",
        sunscreenFormula: "Protection Formula",
        sunscreenFormulaDesc: "Advanced UV filters combined with nourishing antioxidants for complete skin protection",
        arbutinBrief: "Brightening & melanin control",
        vitaminEBrief: "Antioxidant protection",
        cassiaBrief: "Anti-inflammatory care",
        ingTitanium: "Titanium Dioxide",
        titaniumBrief: "Physical UV barrier",

        // Natural Philosophy Page
        philPageTitle: "Natural Philosophy | DERMOCÉAN",
        philHeroTitle: "Our <span>Natural Philosophy</span>",
        philHeroDesc: "We believe in the power of nature. Every ingredient in Dermocéan products is carefully selected from the ocean and earth to deliver real results without harsh chemicals.",
        philCoreTitle: "Core Principles",
        philCoreDesc: "The foundation of everything we create",
        phil100Natural: "100% Botanical",
        phil100NaturalDescLong: "All our active ingredients come directly from nature - marine algae, healing herbs, and flower extracts. No synthetic fillers, just pure botanical power.",
        philMicrobiome: "Microbiome Safe",
        philMicrobiomeDescLong: "Our formulas are designed to work with your skin's natural ecosystem, preserving the beneficial bacteria that keep your skin healthy and balanced.",
        philNoChemicals: "No Harsh Chemicals",
        philNoChemicalsDescLong: "We never use synthetic acids, parabens, or harsh additives. Our products achieve professional results through the natural power of marine microcrystals.",
        philFastHealing: "Fast Recovery",
        philFastHealingDescLong: "Unlike aggressive chemical peels, Dermocéan's natural approach means your skin heals in just 5 days, with minimal downtime and maximum results.",
        philRecoveryTitle: "Your 5-Day Recovery Journey",
        philRecoveryDesc: "Follow the natural healing process",
        philDay1: "Treatment",
        philDay2: "Tightening",
        philDay3: "Peeling",
        philDay4: "Renewal",
        philDay5: "Glow",
        philIngredientsTitle: "Star Ingredients",
        philIngredientsDesc: "The natural heroes behind our formulas",
        ingMarineAlgae: "Marine Algae",
        ingMarineAlgaeDescLong: "The heart of our peeling powder. These natural marine microcrystals gently exfoliate and stimulate collagen production while delivering essential minerals to your skin.",
        ingCalendulaDescLong: "Known for centuries for its healing properties, calendula soothes inflammation, accelerates skin repair, and provides natural antiseptic protection.",
        ingAloeDescLong: "The ultimate soothing ingredient. In our calming mask, aloe vera calms inflammation, delivers deep moisture, and promotes rapid skin regeneration.",
        ingChamomileDescLong: "A gentle yet powerful botanical that reduces redness, calms irritation, and helps sensitive skin recover faster from treatments.",
        benefitExfoliation: "Exfoliation",
        benefitMinerals: "Minerals",
        benefitMoisture: "Deep Moisture",
        benefitGentle: "Gentle",
        benefitSensitive: "For Sensitive Skin",
        philCtaTitle: "Ready to Experience Natural Beauty?",
        philCtaDesc: "Join thousands of beauty professionals who trust Dermocéan",
    ...
    ar: {
        ...
        gentleProtocol: "لطيف",
        gentleDesc: "للبشرة الحساسة. 2 غرام بودر تقشير، من 2 إلى 4 دقائق تدليك.",
        moderateProtocol: "معتدل",
        moderateDesc: "للبشرة العادية. 2 غرام بودر تقشير، من 4 إلى 6 دقائق تدليك.",
        intensiveProtocol: "مكثف",
        intensiveDesc: "للبشرة المقاومة. 2 غرام بودر تقشير، من 6 إلى 8 دقائق تدليك.",
        ...
        step1Tip: "نصيحة احترافية: استخدمي جهاز البخار لفتح المسام قبل العلاج.",
        step2Title: "تحضير الخليط",
        step2Desc: "امزجي 2 غرام من بودر التقشير بالطحالب مع محلول الدعم حتى تحصلي على قوام ناعم ومتساوي.",
        ...
        step5Title: "المسح بلطف",
        step5Desc: "امسحي منطقة العلاج بلطف بقماشة رطبة لإزالة البودرة وبقاياها بشكل كامل.",
        step5Tip: "نصيحة احترافية: استخدمي قماشة ناعمة ورطبة وامسحي بلطف لإزالة جميع الآثار.",
        step6Title: "تطبيق ماسك التهدئة",
        step6Desc: "ضعي طبقة سخية من ماسك التهدئة واتركيها لمدة 10 إلى 15 دقيقة. اتركيه معرضاً للهواء ليبرد على مهله.",
        step6Tip: "نصيحة احترافية: لا تغطي الماسك - اتركيه يبرد بشكل طبيعي على البشرة.",
        step7Title: "الحماية من الشمس",
        step7Desc: "أنهي بواقي شمس SPF 50+. استخدميه كل 3 ساعات للأيام الخمسة التالية. هذا إلزامي.",
        ...
        sunExposure: "تجنبي التعرض للشمس",
        sunExposureDesc: "ابتعدي عن أشعة الشمس المباشرة لمدة 5 أيام بعد العلاج.",
        ...
        treatmentIntervalDesc: "انتظري شهراً على الأقل بين الجلسات. ممنوع إجراء جلسة أقل من شهر.",
        ...
        // Gentle Steps
        gentle_step1: "تدليك لمدة 2 إلى 4 دقائق",
        ...
        // Moderate Steps
        moderate_step1: "تدليك لمدة 4 إلى 6 دقائق",
        ...
        // Intensive Steps
        intensive_step1: "تدليك لمدة 6 إلى 8 دقائق",
        ...
        faq_a2: "قد تشعرين بالحرارة أو الوخز فقط أثناء تطبيق البودرة على البشرة (10 دقائق كحد أقصى). بعد الإزالة، يختفي الإحساس تماماً ولا يوجد ألم.",
        faq_q3: "متى سأبدأ برؤية النتائج؟",
        faq_a3: "ستلاحظين نتيجة ممتازة فورية بعد الجلسة مباشرة. النتيجة الأولية تظهر بعد 5 أيام، والنتيجة النهائية بعد 25 يوم. بالمجمل لا نحتاج أكثر من 4 جلسات حسب حالة البشرة.",
        faq_q4: "هل يمكنني استخدام المنتجات في المنزل؟",
        faq_a4: "للعناية المنزلية بعد العلاج، ننصح فقط بواقي الشمس كل 3 ساعات لمدة 5 أيام. لا حاجة لاستخدام أي منتج آخر.",
        ...
        faq_a8: "لا يجب نزع أو سحب الجلد المتقشر باليد. استخدام واقي الشمس يساعد على تقشره وسقوطه بشكل طبيعي لتجنب جرح البشرة.",
        ...
        preCare1Title: "تجنبي التعرض للشمس",
        preCare1Desc: "تجنبي التعرض للشمس لمدة 5-7 أيام على الأقل لتقليل خطر فرط التصبغ الالتهابي.",
        preCare2Title: "أوقفي المكونات النشطة",
        preCare2Desc: "أوقفي استخدام الريتينول وأحماض AHA وBHA والأحماض النشطة الأخرى 5 أيام قبل العلاج لمنع الحساسية المفرطة.",
        preCare3Title: "لا إجراءات أخرى",
        preCare3Desc: "لا تخضعي للبوتوكس أو الفيلر أو الليزر أو الميكرونيدلينج أو التقشير الكيميائي ضمن الفترات الموصى بها.",
        ...
        daysCare3Desc: "ضعي واقي شمس SPF 50+ كل 3 ساعات. ارتدي قبعة وتجنبي أشعة الشمس المباشرة لمدة 5 أيام.",
        ...
        // Support Solution Page
        support_step1Title: "القياس",
        support_step1Desc: "صبي الكمية المناسبة من محلول الدعم في وعاء الخلط.",
        support_step2Title: "الخلط",
        support_step2Desc: "أضيفي بودرة تقشير الطحالب تدريجياً مع التحريك حتى تتشكل عجينة ناعمة.",
        support_step3Title: "القوام",
        support_step3Desc: "اضبطي النسبة للحصول على القوام المطلوب - أسمك للجسم، أخف للوجه.",
        support_step4Title: "التطبيق",
        support_step4Desc: "استخدميه فوراً بعد الخلط للحصول على أفضل تفعيل ونتائج.",
        roleInTreatment: "الدور في العلاج",
        activatesPowder: "يُفعّل البودرة",
        antisepticAction: "مفعول مطهر",
        maintainsMoisture: "يحافظ على الرطوبة",
        brighteningEffect: "تأثير تفتيح",
        activeIngredients: "المكونات الفعالة",
        supportFormula: "تركيبة الدعم",
        supportFormulaDesc: "مركبات نشطة بيولوجياً مختارة بعناية لتفعيل وتعزيز علاج التقشير",
        daisyBrief: "تفتيح وتوحيد اللون",
        ingGlycerinTitle: "الجلسرين",
        glycerinBrief: "ترطيب عميق وتنعيم",
        ingH2O2: "بيروكسيد الهيدروجين",
        h2o2Brief: "تنقية وتفعيل",

        // Calming Mask Page
        mask_step1Title: "التنظيف",
        mask_step1Desc: "بعد علاج التقشير، أزيلي جميع البقايا بلطف بالماء الدافئ.",
        mask_step2Title: "التطبيق",
        mask_step2Desc: "ضعي طبقة سخية من ماسك التهدئة بالتساوي على المنطقة المعالجة.",
        mask_step3Title: "الانتظار",
        mask_step3Desc: "اتركي الماسك لمدة 15-20 دقيقة للسماح بالامتصاص العميق.",
        mask_step4Title: "الإزالة",
        mask_step4Desc: "أزيليه بلطف بقماشة رطبة أو اشطفيه بماء بارد. ثم ضعي واقي الشمس.",
        skinBenefits: "فوائد البشرة",
        reducesRedness: "يقلل الاحمرار",
        restoresMoisture: "يستعيد الرطوبة",
        calmsSkin: "يهدئ التهيج",
        protectsBarrier: "يحمي الحاجز",
        promoteHealing: "يعزز الشفاء",
        soothingActives: "المكونات المهدئة",
        calmingFormula: "تركيبة التهدئة",
        calmingFormulaDesc: "مستخلصات نباتية ومركبات مرطبة مصممة لاستعادة البشرة بعد العلاجات المكثفة",
        aloeBrief: "علاجي ومضاد للالتهاب",
        cucumberBrief: "مبرد ومنعش",
        hyaluronateBrief: "احتفاظ عميق بالرطوبة",
        chamomileBrief: "مضاد للاحمرار ومهدئ",

        // Sunscreen Page
        sun_step1Title: "التحضير",
        sun_step1Desc: "ضعيه على بشرة نظيفة وجافة كخطوة أخيرة في روتين العناية بالبشرة.",
        sun_step2Title: "التطبيق",
        sun_step2Desc: "استخدمي كمية سخية ووزعيها بالتساوي على الوجه والرقبة والمناطق المكشوفة.",
        sun_step3Title: "الانتظار",
        sun_step3Desc: "انتظري 15 دقيقة قبل التعرض للشمس للحصول على حماية مثالية.",
        sun_step4Title: "إعادة التطبيق",
        sun_step4Desc: "أعيدي التطبيق كل ساعتين، أو بعد السباحة أو التعرق الشديد.",
        protectiveActives: "المكونات الواقية",
        sunscreenFormula: "تركيبة الحماية",
        sunscreenFormulaDesc: "مرشحات UV متطورة مع مضادات أكسدة مغذية لحماية كاملة للبشرة",
        arbutinBrief: "تفتيح والتحكم بالميلانين",
        vitaminEBrief: "حماية مضادة للأكسدة",
        cassiaBrief: "عناية مضادة للالتهاب",
        ingTitanium: "ثاني أكسيد التيتانيوم",
        titaniumBrief: "حاجز UV فيزيائي",

        // Natural Philosophy Page
        philPageTitle: "الفلسفة الطبيعية | ديرموسيان",
        philHeroTitle: "<span>فلسفتنا</span> الطبيعية",
        philHeroDesc: "نؤمن بقوة الطبيعة. كل مكون في منتجات ديرموسيان مختار بعناية من المحيط والأرض لتقديم نتائج حقيقية بدون مواد كيميائية قاسية.",
        philCoreTitle: "المبادئ الأساسية",
        philCoreDesc: "الأساس الذي نبني عليه كل ما نصنعه",
        phil100Natural: "نباتي 100%",
        phil100NaturalDescLong: "جميع مكوناتنا الفعالة تأتي مباشرة من الطبيعة - الطحالب البحرية، الأعشاب الشافية، ومستخلصات الزهور. بدون حشوات صناعية، فقط قوة نباتية نقية.",
        philMicrobiome: "آمن للميكروبيوم",
        philMicrobiomeDescLong: "تركيباتنا مصممة للعمل مع النظام البيئي الطبيعي لبشرتك، وتحافظ على البكتيريا المفيدة التي تبقي بشرتك صحية ومتوازنة.",
        philNoChemicals: "بدون مواد كيميائية قاسية",
        philNoChemicalsDescLong: "لا نستخدم أبداً الأحماض الصناعية أو البارابين أو الإضافات القاسية. منتجاتنا تحقق نتائج احترافية من خلال القوة الطبيعية للبلورات البحرية الدقيقة.",
        philFastHealing: "تعافٍ سريع",
        philFastHealingDescLong: "على عكس التقشير الكيميائي العنيف، نهج ديرموسيان الطبيعي يعني أن بشرتك تتعافى في 5 أيام فقط، مع أقل فترة توقف وأقصى نتائج.",
        philRecoveryTitle: "رحلة التعافي في 5 أيام",
        philRecoveryDesc: "تابعي عملية الشفاء الطبيعية",
        philDay1: "العلاج",
        philDay2: "الشد",
        philDay3: "التقشر",
        philDay4: "التجدد",
        philDay5: "التوهج",
        philIngredientsTitle: "المكونات النجمة",
        philIngredientsDesc: "الأبطال الطبيعيون وراء تركيباتنا",
        ingMarineAlgae: "الطحالب البحرية",
        ingMarineAlgaeDescLong: "قلب بودرة التقشير لدينا. هذه البلورات البحرية الطبيعية تقشر بلطف وتحفز إنتاج الكولاجين مع توصيل المعادن الأساسية لبشرتك.",
        ingCalendulaDescLong: "معروف منذ قرون بخصائصه العلاجية، الكاليندولا يهدئ الالتهاب، يسرع إصلاح البشرة، ويوفر حماية مطهرة طبيعية.",
        ingAloeDescLong: "المكون المهدئ الأمثل. في ماسك التهدئة لدينا، الصبار يهدئ الالتهاب، يوفر ترطيب عميق، ويعزز تجدد البشرة السريع.",
        ingChamomileDescLong: "مكون نباتي لطيف لكنه قوي يقلل الاحمرار، يهدئ التهيج، ويساعد البشرة الحساسة على التعافي أسرع من العلاجات.",
        benefitExfoliation: "تقشير",
        benefitMinerals: "معادن",
        benefitMoisture: "ترطيب عميق",
        benefitGentle: "لطيف",
        benefitSensitive: "للبشرة الحساسة",
        philCtaTitle: "مستعدة لتجربة الجمال الطبيعي؟",
        philCtaDesc: "انضمي لآلاف المتخصصين في التجميل الذين يثقون بديرموسيان",
        naturalPhilosophy: "الفلسفة الطبيعية"
    },
    fr: {
        // Navigation
        home: "Accueil",
        ...
        gentleProtocol: "Doux",
        gentleDesc: "Pour peaux sensibles. 2g de poudre, 2-4 min de massage.",
        moderateProtocol: "Modéré",
        moderateDesc: "Pour peaux normales. 2g de poudre, 4-6 min de massage.",
        intensiveProtocol: "Intensif",
        intensiveDesc: "Pour peaux résistantes. 2g de poudre, 6-8 min de massage.",
        ...
        step1Tip: "Conseil Pro: Utilisez un vaporisateur facial pour ouvrir les pores avant le traitement.",
        step2Title: "Préparer le Mélange",
        step2Desc: "Mélangez 2g de Poudre de Peeling aux Algues avec la Solution Support jusqu'a obtenir une consistance lisse et uniforme.",
        ...
        step5Title: "Essuyer Délicatement",
        step5Desc: "Essuyez délicatement la zone de traitement avec des lingettes humides pour éliminer complètement la poudre et ses résidus.",
        step5Tip: "Conseil Pro: Utilisez des lingettes douces et humides pour enlever toutes traces.",
        step6Title: "Appliquer le Masque Apaisant",
        step6Desc: "Appliquez une couche généreuse de Masque Apaisant pendant 10-15 minutes. Laissez exposé à l'air pour refroidir naturellement.",
        step6Tip: "Conseil Pro: Ne pas couvrir - laissez le masque refroidir naturellement sur la peau.",
        step7Title: "Protection Solaire",
        step7Desc: "Terminez avec un écran solaire SPF 50+. Appliquez toutes les 3 heures pendant 5 jours. C'est OBLIGATOIRE.",
        ...
        sunExposureDesc: "Restez à l'écart de la lumière directe du soleil pendant 5 jours après le traitement.",
        ...
        treatmentIntervalDesc: "Attendez au moins 1 mois entre les séances. Les séances à moins d'1 mois d'intervalle ne sont pas autorisées.",
        ...
        // Gentle Steps
        gentle_step1: "2-4 minutes de massage",
        ...
        // Moderate Steps
        moderate_step1: "4-6 minutes de massage",
        ...
        // Intensive Steps
        intensive_step1: "6-8 minutes de massage",
        ...
        faq_a2: "Vous pouvez ressentir de la chaleur ou des picotements uniquement pendant l'application de la poudre (maximum 10 minutes). Après le retrait, la sensation disparaît complètement sans douleur.",
        faq_q3: "Quand vais-je commencer à voir des résultats?",
        faq_a3: "Vous verrez d'excellents résultats immédiatement après la séance. Les résultats initiaux apparaissent après 5 jours, avec les résultats finaux à 25 jours. En général, pas plus de 4 séances sont nécessaires selon l'état de la peau.",
        faq_q4: "Puis-je utiliser les produits à la maison?",
        faq_a4: "Pour les soins à domicile après le traitement, nous recommandons uniquement l'application d'écran solaire SPF 50+ toutes les 3 heures pendant 5 jours. Aucun autre produit n'est nécessaire.",
        ...
        faq_a8: "Ne jamais arracher ou tirer sur la peau qui pèle à la main. L'utilisation d'écran solaire aide la peau à peler et tomber naturellement, évitant tout dommage à la peau.",
        ...
        daysCare3Desc: "Appliquez un écran solaire SPF 50+ toutes les 3 heures. Portez un chapeau et évitez la lumière directe du soleil pendant 5 jours.",
        ...
        // Support Solution Page
        support_step1Title: "Mesurer",
        support_step1Desc: "Versez la quantité appropriée de Solution Support dans un bol de mélange.",
        support_step2Title: "Mélanger",
        support_step2Desc: "Ajoutez progressivement la Poudre Peeling aux Algues tout en remuant jusqu'à obtenir une pâte lisse.",
        support_step3Title: "Consistance",
        support_step3Desc: "Ajustez le ratio pour la consistance désirée - plus épaisse pour le corps, plus fluide pour le visage.",
        support_step4Title: "Appliquer",
        support_step4Desc: "Utilisez immédiatement après le mélange pour une activation et des résultats optimaux.",
        roleInTreatment: "Rôle dans le Traitement",
        activatesPowder: "Active la Poudre",
        antisepticAction: "Action Antiseptique",
        maintainsMoisture: "Maintient l'Hydratation",
        brighteningEffect: "Effet Éclaircissant",
        activeIngredients: "Ingrédients Actifs",
        supportFormula: "Formule Support",
        supportFormulaDesc: "Composés bioactifs soigneusement sélectionnés pour activer et améliorer le traitement peeling",
        daisyBrief: "Éclaircit et unifie le teint",
        ingGlycerinTitle: "Glycérine",
        glycerinBrief: "Hydratation profonde et adoucissement",
        ingH2O2: "Peroxyde d'Hydrogène",
        h2o2Brief: "Purification et activation",

        // Calming Mask Page
        mask_step1Title: "Nettoyer",
        mask_step1Desc: "Après le traitement peeling, retirez délicatement tous les résidus à l'eau tiède.",
        mask_step2Title: "Appliquer",
        mask_step2Desc: "Appliquez une couche généreuse de Masque Apaisant uniformément sur la zone traitée.",
        mask_step3Title: "Patienter",
        mask_step3Desc: "Laissez le masque pendant 15-20 minutes pour permettre une absorption profonde.",
        mask_step4Title: "Retirer",
        mask_step4Desc: "Retirez délicatement avec un chiffon humide ou rincez à l'eau froide. Appliquez ensuite le SPF.",
        skinBenefits: "Bienfaits pour la Peau",
        reducesRedness: "Réduit les Rougeurs",
        restoresMoisture: "Restaure l'Hydratation",
        calmsSkin: "Calme les Irritations",
        protectsBarrier: "Protège la Barrière",
        promoteHealing: "Favorise la Guérison",
        soothingActives: "Actifs Apaisants",
        calmingFormula: "Formule Apaisante",
        calmingFormulaDesc: "Extraits botaniques et composés hydratants conçus pour restaurer la peau après les traitements intensifs",
        aloeBrief: "Guérison et anti-inflammatoire",
        cucumberBrief: "Rafraîchissant et apaisant",
        hyaluronateBrief: "Rétention d'hydratation profonde",
        chamomileBrief: "Anti-rougeurs et calmant",

        // Sunscreen Page
        sun_step1Title: "Préparer",
        sun_step1Desc: "Appliquez sur une peau propre et sèche comme dernière étape de votre routine de soin.",
        sun_step2Title: "Appliquer",
        sun_step2Desc: "Utilisez une quantité généreuse et étalez uniformément sur le visage, le cou et les zones exposées.",
        sun_step3Title: "Patienter",
        sun_step3Desc: "Attendez 15 minutes avant l'exposition au soleil pour une protection optimale.",
        sun_step4Title: "Réappliquer",
        sun_step4Desc: "Réappliquez toutes les 2 heures, ou après la baignade ou une transpiration excessive.",
        protectiveActives: "Actifs Protecteurs",
        sunscreenFormula: "Formule Protection",
        sunscreenFormulaDesc: "Filtres UV avancés combinés avec des antioxydants nourrissants pour une protection complète de la peau",
        arbutinBrief: "Éclaircissant et contrôle de la mélanine",
        vitaminEBrief: "Protection antioxydante",
        cassiaBrief: "Soin anti-inflammatoire",
        ingTitanium: "Dioxyde de Titane",
        titaniumBrief: "Barrière UV physique",

        // Natural Philosophy Page
        philPageTitle: "Philosophie Naturelle | DERMOCÉAN",
        philHeroTitle: "Notre <span>Philosophie Naturelle</span>",
        philHeroDesc: "Nous croyons au pouvoir de la nature. Chaque ingrédient des produits Dermocéan est soigneusement sélectionné de l'océan et de la terre pour des résultats réels sans produits chimiques agressifs.",
        philCoreTitle: "Principes Fondamentaux",
        philCoreDesc: "La base de tout ce que nous créons",
        phil100Natural: "100% Botanique",
        phil100NaturalDescLong: "Tous nos ingrédients actifs proviennent directement de la nature - algues marines, herbes guérissantes et extraits de fleurs. Sans charges synthétiques, juste la puissance botanique pure.",
        philMicrobiome: "Microbiome Sûr",
        philMicrobiomeDescLong: "Nos formules sont conçues pour travailler avec l'écosystème naturel de votre peau, préservant les bactéries bénéfiques qui maintiennent votre peau saine et équilibrée.",
        philNoChemicals: "Sans Produits Chimiques",
        philNoChemicalsDescLong: "Nous n'utilisons jamais d'acides synthétiques, de parabènes ou d'additifs agressifs. Nos produits obtiennent des résultats professionnels grâce au pouvoir naturel des microcristaux marins.",
        philFastHealing: "Récupération Rapide",
        philFastHealingDescLong: "Contrairement aux peelings chimiques agressifs, l'approche naturelle de Dermocéan signifie que votre peau guérit en seulement 5 jours, avec un temps d'arrêt minimal et des résultats maximaux.",
        philRecoveryTitle: "Votre Parcours de Récupération en 5 Jours",
        philRecoveryDesc: "Suivez le processus de guérison naturel",
        philDay1: "Traitement",
        philDay2: "Tension",
        philDay3: "Peeling",
        philDay4: "Renouvellement",
        philDay5: "Éclat",
        philIngredientsTitle: "Ingrédients Stars",
        philIngredientsDesc: "Les héros naturels derrière nos formules",
        ingMarineAlgae: "Algues Marines",
        ingMarineAlgaeDescLong: "Le cœur de notre poudre de peeling. Ces microcristaux marins naturels exfolient doucement et stimulent la production de collagène tout en délivrant des minéraux essentiels à votre peau.",
        ingCalendulaDescLong: "Connu depuis des siècles pour ses propriétés curatives, le calendula apaise l'inflammation, accélère la réparation de la peau et offre une protection antiseptique naturelle.",
        ingAloeDescLong: "L'ingrédient apaisant ultime. Dans notre masque calmant, l'aloe vera calme l'inflammation, délivre une hydratation profonde et favorise la régénération rapide de la peau.",
        ingChamomileDescLong: "Un botanique doux mais puissant qui réduit les rougeurs, calme les irritations et aide les peaux sensibles à récupérer plus rapidement des traitements.",
        benefitExfoliation: "Exfoliation",
        benefitMinerals: "Minéraux",
        benefitMoisture: "Hydratation Profonde",
        benefitGentle: "Doux",
        benefitSensitive: "Pour Peaux Sensibles",
        philCtaTitle: "Prête à Découvrir la Beauté Naturelle?",
        philCtaDesc: "Rejoignez des milliers de professionnels de la beauté qui font confiance à Dermocéan",
        naturalPhilosophy: "Philosophie Naturelle"
    },
    tr: {
        // Navigation
        home: "Ana Sayfa",
        ...
        gentleDesc: "Hassas ciltler için. 2g toz, 2-4 dk masaj.",
        moderateProtocol: "Orta",
        moderateDesc: "Normal ciltler için. 2g toz, 4-6 dk masaj.",
        intensiveProtocol: "Yoğun",
        intensiveDesc: "Dirençli ciltler için. 2g toz, 6-8 dk masaj.",
        ...
        step1Tip: "Pro İpucu: Tedaviden önce gözenekleri açmak için yüz buharı cihazı kullanın.",
        step2Title: "Karışımı Hazırlayın",
        step2Desc: "2g Yosun Peeling Tozunu Destek Solüsyonu ile pürüzsüz ve eşit bir kıvam elde edene kadar karıştırın.",
        ...
        step5Title: "Nazikçe Silin",
        step5Desc: "Tedavi bölgesini nemli bezlerle nazikçe silerek tüm toz ve kalıntıları tamamen temizleyin.",
        step5Tip: "Pro İpucu: Yumusak, nemli bezler kullanın ve tüm izleri temizlemek için nazikçe silin.",
        step6Title: "Yatıştırıcı Maske Uygulayın",
        step6Desc: "Yatıştırıcı Maske'den bol miktarda uygulayın ve 10-15 dakika bekletin. Havaya açık bırakın, doğal olarak soğumasina izin verin.",
        step6Tip: "Pro İpucu: Örtmeyin - maskenin ciltte doğal olarak soğumasina izin verin.",
        step7Title: "Güneş Koruması",
        step7Desc: "SPF 50+ güneş kremi ile bitirin. 5 gün boyunca 3 saatte bir uygulayın. Bu ZORUNLUDUR.",
        ...
        sunExposureDesc: "Tedaviden sonra 5 gün doğrudan güneş ışığından uzak durun.",
        ...
        treatmentIntervalDesc: "Seanslar arasında en az 1 ay bekleyin. 1 aydan kısa aralıklı seanslar yasaktır.",
        ...
        // Moderate Steps
        moderate_step1: "4-6 dakika masaj",
        ...
        // Intensive Steps
        intensive_step1: "6-8 dakika masaj",
        ...
        faq_a2: "Isınma veya karıncalanma hissi sadece pudra uygulaması sırasında (maksimum 10 dakika) hissedilebilir. Temizlendikten sonra his tamamen kaybolur ve ağrı olmaz.",
        faq_q3: "Ne zaman sonuç görmeye başlayacağım?",
        faq_a3: "Seanstan hemen sonra mükemmel sonuçlar göreceksiniz. İlk sonuçlar 5 gün sonra, nihai sonuçlar 25 günde görülür. Cilt durumuna göre genellikle 4'ten fazla seansa gerek yoktur.",
        faq_q4: "Ürünleri evde kullanabilir miyim?",
        faq_a4: "Tedavi sonrası evde bakım için sadece 5 gün boyunca 3 saatte bir SPF 50+ güneş kremi uygulamayı öneriyoruz. Başka ürüne gerek yoktur.",
        ...
        faq_a8: "Soyulan cildi asla elle koparıp çekmeyin. Güneş kremi kullanmak cildin doğal olarak soyulup düşmesine yardımcı olur ve cilde zarar vermez.",
        ...
        daysCare3Desc: "Her 3 saatte bir SPF 50+ güneş kremi uygulayın. Şapka takın ve 5 gün boyunca doğrudan güneş ışığından kaçının.",
        ...
        // Support Solution Page
        support_step1Title: "Ölçün",
        support_step1Desc: "Karıştırma kasesine uygun miktarda Destek Solüsyonu dökün.",
        support_step2Title: "Karıştırın",
        support_step2Desc: "Pürüzsüz bir macun oluşana kadar karıştırarak Yosun Peeling Tozunu kademeli olarak ekleyin.",
        support_step3Title: "Kıvam",
        support_step3Desc: "İstenen kıvam için oranı ayarlayın - vücut için daha kalın, yüz için daha ince.",
        support_step4Title: "Uygulayın",
        support_step4Desc: "Optimal aktivasyon ve sonuçlar için karıştırdıktan hemen sonra kullanın.",
        roleInTreatment: "Tedavideki Rolü",
        activatesPowder: "Tozu Aktive Eder",
        antisepticAction: "Antiseptik Etki",
        maintainsMoisture: "Nemi Korur",
        brighteningEffect: "Aydınlatıcı Etki",
        activeIngredients: "Aktif İçerikler",
        supportFormula: "Destek Formülü",
        supportFormulaDesc: "Peeling tedavisini aktive etmek ve geliştirmek için özenle seçilmiş biyoaktif bileşikler",
        daisyBrief: "Aydınlatır ve tonu eşitler",
        ingGlycerinTitle: "Gliserin",
        glycerinBrief: "Derin nemlendirme ve yumuşatma",
        ingH2O2: "Hidrojen Peroksit",
        h2o2Brief: "Arındırma ve aktivasyon",

        // Calming Mask Page
        mask_step1Title: "Temizleyin",
        mask_step1Desc: "Peeling tedavisinden sonra, tüm kalıntıları ılık suyla nazikçe temizleyin.",
        mask_step2Title: "Uygulayın",
        mask_step2Desc: "Tedavi edilen bölgeye eşit şekilde bol miktarda Yatıştırıcı Maske uygulayın.",
        mask_step3Title: "Bekleyin",
        mask_step3Desc: "Derin emilim için maskeyi 15-20 dakika bekletin.",
        mask_step4Title: "Çıkarın",
        mask_step4Desc: "Nemli bir bezle nazikçe çıkarın veya soğuk suyla durulayın. Ardından SPF uygulayın.",
        skinBenefits: "Cilt Faydaları",
        reducesRedness: "Kızarıklığı Azaltır",
        restoresMoisture: "Nemi Geri Kazandırır",
        calmsSkin: "Tahrişi Yatıştırır",
        protectsBarrier: "Bariyeri Korur",
        promoteHealing: "İyileşmeyi Destekler",
        soothingActives: "Yatıştırıcı Aktifler",
        calmingFormula: "Yatıştırıcı Formül",
        calmingFormulaDesc: "Yoğun tedavilerden sonra cildi restore etmek için tasarlanmış botanik ekstraktlar ve nemlendirici bileşikler",
        aloeBrief: "İyileştirici ve anti-enflamatuar",
        cucumberBrief: "Serinletici ve ferahlatıcı",
        hyaluronateBrief: "Derin nem tutma",
        chamomileBrief: "Kızarıklık giderici ve yatıştırıcı",

        // Sunscreen Page
        sun_step1Title: "Hazırlayın",
        sun_step1Desc: "Cilt bakım rutininizin son adımı olarak temiz ve kuru cilde uygulayın.",
        sun_step2Title: "Uygulayın",
        sun_step2Desc: "Bol miktarda kullanın ve yüz, boyun ve açık alanlara eşit şekilde yayın.",
        sun_step3Title: "Bekleyin",
        sun_step3Desc: "Optimal koruma için güneşe maruz kalmadan 15 dakika önce uygulayın.",
        sun_step4Title: "Yenileyin",
        sun_step4Desc: "Her 2 saatte bir veya yüzme veya aşırı terleme sonrası yeniden uygulayın.",
        protectiveActives: "Koruyucu Aktifler",
        sunscreenFormula: "Koruma Formülü",
        sunscreenFormulaDesc: "Tam cilt koruması için besleyici antioksidanlarla birleştirilmiş gelişmiş UV filtreleri",
        arbutinBrief: "Aydınlatıcı ve melanin kontrolü",
        vitaminEBrief: "Antioksidan koruma",
        cassiaBrief: "Anti-enflamatuar bakım",
        ingTitanium: "Titanyum Dioksit",
        titaniumBrief: "Fiziksel UV bariyeri",

        // Natural Philosophy Page
        philPageTitle: "Doğal Felsefe | DERMOCÉAN",
        philHeroTitle: "<span>Doğal</span> Felsefemiz",
        philHeroDesc: "Doğanın gücüne inanıyoruz. Dermocéan ürünlerindeki her içerik, sert kimyasallar olmadan gerçek sonuçlar vermek için okyanus ve dünyadan özenle seçilmiştir.",
        philCoreTitle: "Temel İlkeler",
        philCoreDesc: "Yarattığımız her şeyin temeli",
        phil100Natural: "%100 Botanik",
        phil100NaturalDescLong: "Tüm aktif içeriklerimiz doğrudan doğadan gelir - deniz yosunları, şifalı otlar ve çiçek özleri. Sentetik dolgular yok, sadece saf botanic güç.",
        philMicrobiome: "Mikrobiyom Güvenli",
        philMicrobiomeDescLong: "Formüllerimiz cildinizin doğal ekosistemiyle çalışmak üzere tasarlanmış olup cildinizi sağlıklı ve dengeli tutan yararlı bakterileri korur.",
        philNoChemicals: "Sert Kimyasallar Yok",
        philNoChemicalsDescLong: "Asla sentetik asitler, parabenler veya sert katkı maddeleri kullanmıyoruz. Ürünlerimiz deniz mikrokristallerinin doğal gücüyle profesyonel sonuçlar elde eder.",
        philFastHealing: "Hızlı İyileşme",
        philFastHealingDescLong: "Agresif kimyasal peelinglarin aksine, Dermocéan'ın doğal yaklaşımı cildinizin sadece 5 günde iyileşmesi, minimum kesinti süresi ve maksimum sonuçlar anlamına gelir.",
        philRecoveryTitle: "5 Günlük İyileşme Yolculuğunuz",
        philRecoveryDesc: "Doğal iyileşme sürecini takip edin",
        philDay1: "Tedavi",
        philDay2: "Gerginlik",
        philDay3: "Soyulma",
        philDay4: "Yenilenme",
        philDay5: "Parlaklık",
        philIngredientsTitle: "Yıldız İçerikler",
        philIngredientsDesc: "Formüllerimizin arkasındaki doğal kahramanlar",
        ingMarineAlgae: "Deniz Yosunları",
        ingMarineAlgaeDescLong: "Peeling tozumuzun kalbi. Bu doğal deniz mikrokristalleri nazikçe eksfoliye eder ve cildinize temel mineraller sunarken kolajen üretimini uyarır.",
        ingCalendulaDescLong: "Yüzyıllardır iyileştirici özellikleriyle bilinen calendula, iltihabı yatıştırır, cilt onarımını hızlandırır ve doğal antiseptik koruma sağlar.",
        ingAloeDescLong: "En iyi yatıştırıcı içerik. Yatıştırıcı maskemizde aloe vera iltihabı yatıştırır, derin nem sağlar ve hızlı cilt rejenerasyonunu destekler.",
        ingChamomileDescLong: "Kızarıklığı azaltan, tahrişi yatıştıran ve hassas cildin tedavilerden daha hızlı iyileşmesine yardımcı olan nazik ama güçlü bir botanic.",
        benefitExfoliation: "Eksfoliasyon",
        benefitMinerals: "Mineraller",
        benefitMoisture: "Derin Nem",
        benefitGentle: "Nazik",
        benefitSensitive: "Hassas Ciltler İçin",
        philCtaTitle: "Doğal Güzelliği Keşfetmeye Hazır mısınız?",
        philCtaDesc: "Dermocéan'a güvenen binlerce güzellik profesyoneline katılın",
        naturalPhilosophy: "Doğal Felsefe"
    }
};
